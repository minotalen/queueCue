...
(function() {
  var Favico = function(opt) {
    ...
    var init = function() {
      ...
      _opt.animation = animation.types["" + _opt.animation]
        ? _opt.animation
        : _def.animation;
      ...
      if (lastIcon.hasAttribute("href")) {
        ...
        _img.onload = function() {
          _h = _img.height > 0 ? _img.height : 64;
          _w = _img.width > 0 ? _img.width : 64;
          _canvas.height = _h;
          _canvas.width = _w;
    ...
    icon.reset = function() {
      ...
      _lastBadge = false;
      _running = false;
      _context.clearRect(0, 0, 64, 64);
      _context.drawImage(_img, 0, 0, 64, 64);
      //_stop=true;
    ...
    type.circle = function(opt) {
      ...
      _context.font =
        _opt.fontStyle +
        " " +
        Math.floor(opt.h * (opt.n > 99 ? 0.85 : 1)) +
        "px " +
        _opt.fontFamily;
    ...
    type.rectangle = function(opt) {
      ...
      _context.font =
        _opt.fontStyle +
        " " +
        Math.floor(opt.h * (opt.n > 99 ? 0.9 : 1)) +
        "px " +
        _opt.fontFamily;
      _context.textAlign = "center";
      _context.fillStyle =
    ...
    var image = function(imageElement) {
      _readyCb = function() {
        try {
          ...
          console.log(" w ", w, " _w", _w, " h ", h, " _h ", _h);
    ...
    function isPageHidden() {
      return (
        _doc.hidden || _doc.msHidden || _doc.webkitHidden || _doc.mozHidden
      );
    }
